...
class QString implements ffi.Finalizable {
  ...
  QString.ctor2(QByteArray? a) {
    final voidstar_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_voidstar_FFI>>(
            'c_QString__constructor_QByteArray')
        .asFunction();
    thisCpp = func(a == null ? ffi.nullptr : a.thisCpp);
    QString.s_dartInstanceByCppPtr[thisCpp.address] = this;
  } //QString(const char * ch)
  QString.ctor3(String? ch) {
    final voidstar_Func_string func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_string_FFI>>(
            'c_QString__constructor_char')
        .asFunction();
    thisCpp = func(ch?.toNativeUtf8() ?? ffi.nullptr);
    QString.s_dartInstanceByCppPtr[thisCpp.address] = this;
  } // append(const QByteArray & s)
  QString append(QByteArray? s) {
    final voidstar_Func_voidstar_voidstar func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_voidstar_voidstar_FFI>>(
            'c_QString__append_QByteArray')
        .asFunction();
  ...
  QString insert_3(int i, String? s) {
    final voidstar_Func_voidstar_int_string func = _dylib
        .lookup<
                ffi
                .NativeFunction<voidstar_Func_voidstar_ffi_Int32_string_FFI>>(
            'c_QString__insert_qsizetype_char')
        .asFunction();
    ffi.Pointer<void> result =
        func(thisCpp, i, s?.toNativeUtf8() ?? ffi.nullptr);
    return QString.fromCppPointer(result, false);
  ...
  QString prepend(QByteArray? s) {
    final voidstar_Func_voidstar_voidstar func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_voidstar_voidstar_FFI>>(
            'c_QString__prepend_QByteArray')
        .asFunction();
    ffi.Pointer<void> result =
        func(thisCpp, s == null ? ffi.nullptr : s.thisCpp);
    return QString.fromCppPointer(result, false);
  ...
  QString prepend_3(String? s) {
    final voidstar_Func_voidstar_string func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_voidstar_string_FFI>>(
            'c_QString__prepend_char')
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, s?.toNativeUtf8() ?? ffi.nullptr);
    return QString.fromCppPointer(result, false);
  ...
  QList split(String? sep) {
    final voidstar_Func_voidstar_voidstar func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_voidstar_voidstar_FFI>>(
            'c_QString__split_QString')
        .asFunction();
    ffi.Pointer<void> result =
        func(thisCpp, sep?.toNativeUtf8() ?? ffi.nullptr);
