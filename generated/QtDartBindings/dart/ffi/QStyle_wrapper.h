...
// tag=1067
//  QStyle::drawControl(QStyle::ControlElement element, const QStyleOption *
//  opt, QPainter * p, const QWidget * w) const
QtDartBindings_EXPORT void
c_QStyle__drawControl_ControlElement_QStyleOption_QPainter_QWidget(
    void *thisObj, int element, void *opt_, void *p_, void *w_);

// tag=1067
//  QStyle::drawItemPixmap(QPainter * painter, const QRect & rect, int
...
// tag=1067
//  QStyle::drawItemText(QPainter * painter, const QRect & rect, int flags,
//  const QPalette & pal, bool enabled, const QString & text,
...
// tag=1067
//  QStyle::visualRect(Qt::LayoutDirection direction, const QRect &
//  boundingRect, const QRect & logicalRect)
QtDartBindings_EXPORT void *
...
c_QStyle__registerVirtualMethodCallback(void *ptr, void *callback,
                                        int methodId);
// tag=1047
QtDartBindings_EXPORT void c_QStyle_Finalizer(void *, void *cppObj, void *);
}
